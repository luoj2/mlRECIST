...
out = open('../log_test/predict_progression/log_' + str(FLAGS.learning_rate) + "_" + str(FLAGS.init) + "_" + str(FLAGS.batch_size)+ "_" + str(FLAGS.num_epochs) + ".txt",'w')
out.write("\nParameters:\n")
print("\nParameters:")
...
#                     print("Ground truth",y_test)
                    ...
                    with open('../log_test/predict_progression/result_' + str(FLAGS.learning_rate) + "_" + str(FLAGS.init) + "_" + str(FLAGS.batch_size) + '.txt','w') as rec:
                        for i in range(len(pre)):
